(() => {
    ...
    const MOCK_TRANSACTIONS = [
        ...
        { id: "TXN-90217", account: "Acc...4412 (Men)", type: "ATM Cash Withdrawal", amount: "$10,000,000", time: "07:30:00", status: "Success" },
    ...
    function initializeDashboardData() {
        ...
        if (document.getElementById("accountCount")) {
            document.getElementById("accountCount").textContent = "$40,000,000";
            document.getElementById("depositTotal").textContent = "$40,000,000";
            ...
            <div class="dashboard-grid">
                ...
                <div class="dashboard-card">
                    <a href="https://tharahuokaing.github.io/total_account/" style="text-decoration: none; color: inherit; display: block; height: 100%; width: 100%;">
                        ...
                        <h3 id="accountCount">$40,000,000</h3>
                        <p>Total Accounts</p>
                ...
                <div class="dashboard-card">
                    <a href="https://tharahuokaing.github.io/deposit/" style="text-decoration: none; color: inherit; display: block; height: 100%; width: 100%;">
                        ...
                        <h3 id="depositTotal">$40,000,000</h3>
                        <p>Total Deposits</p>
                        <span class="card-link">View Details</span>
                    </a>
                </div>
